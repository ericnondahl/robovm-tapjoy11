...
@NativeClass
public class TJPlacement extends NSObject {

	static { ObjCRuntime.bind(TJPlacement.class); }
	...
	* @return n/a
	*/
	@Method(selector = "requestContent")
	...
	* @return n/a
	*/
	@Method(selector = "showContentWithViewController:")
	public native void showContent(UIViewController viewController);
}

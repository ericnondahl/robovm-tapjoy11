...
public class Tapjoy extends NSObject {
	...
	*/
	...
	public static native void connect(String sdkKey);
	...
	* @return n/a
	*/
	@Method(selector = "connect:options:")
	public static native void connect(String sdkKey, NSDictionary optionsDict);
	...
	* @return n/a
	*/
	@Method(selector = "actionComplete:")
	public static native void actionComplete(String actionID);
